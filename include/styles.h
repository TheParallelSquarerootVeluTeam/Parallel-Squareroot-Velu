...
// df  : dummy-free variant using two torsion points
	...
	#elif defined ctidh
	#include "strategy/csidh-512-ctidh.h"
	#else
	...
	#elif defined ctidh
	#include "strategy/csidh-1024-ctidh.h"
	#else
	#error Strategy not found
	#endif
	...
	#elif defined ctidh
	#include "strategy/csidh-2048-ctidh.h"
	#else
	#error Strategy not found
	#endif
...
#elif defined Ptest
	#if defined wd2
	#include "strategy/csidh-test-wd2.h"
	#elif defined wd1
	#include "strategy/csidh-test-wd1.h"
    #elif defined df
	#include "strategy/csidh-test-df.h"
	#else
	#error Strategy not found
	#endif
